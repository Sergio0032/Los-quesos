...
try:
    ...
    # Creamos dos columnas: una muy estrecha para el escudo y otra ancha para el nombre
    ...
    with col_titulo:
        # st.title tiene mucho margen por defecto, usamos st.header para que quede mejor alineado con la foto
        st.header(liga_sel)
